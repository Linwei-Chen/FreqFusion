...
model = dict(
    ...
    panoptic_head=dict(
        ...
        # type='Mask2FormerHeadAS',
        # pixel_relation=[1, 2, 4, 8, 16], ###、
...
lr_config = dict(
    ...
    by_epoch=False,
    # step=[327778, 355092],
    step=[78667, 85222], ### 12epoch/50epoch = 0.24
    # step=[69227, 75745], ### 12epoch/50epoch = 0.24
    # step=[19667, 21306], ### 12epoch/50epoch = 0.24 
    warmup='linear',
